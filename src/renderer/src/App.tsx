  ...
  return (
    <MenssageGeneralContext.Provider value={{ mensajeGeneral, setmensajeGeneral }}>
      <div className="conteiner">
        ...
        {selectScreen.auto ? (
          <Automatico datosSerial={datosSerial} closeWindows={setSelectScreen} tranferirPorLitros={{tranferir:() =>setActiveProceso({ activar: true, proceso: 'transferirLitros' }), setearCicloApp:()=> setCiclo(0)} } />
        ) : null}
